...
public class TestCase_15 extends BasePage {

    public TestCase_15(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    //TestCase 15 : Validate Filter by Price(Success) Doubts

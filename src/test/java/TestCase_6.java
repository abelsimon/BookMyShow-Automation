...
public class TestCase_6 extends BasePage {
    ...
    //TestCase 06 : List Your Show-What are the services we offer(Success)
    public void offerService() throws IOException {
        try {
            ...
            takeScreenshot("ServiceOffer");
        } catch (Exception e) {
            Reports.extentTest.log(Status.FAIL, e);
            takeScreenshot("ServiceOfferFailed");
        }

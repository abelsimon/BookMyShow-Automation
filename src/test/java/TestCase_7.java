...
public class TestCase_7 extends BasePage {

    public TestCase_7(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    //TestCase 07 : List Your Show-Reports & Business insights details(Success)
    public void reportShow() throws IOException {
        try {
            ...
            takeScreenshot("ShowReports");
        } catch (Exception e) {
            Reports.extentTest.log(Status.FAIL, e);
            takeScreenshot("ShowReports_Failed");
        }
